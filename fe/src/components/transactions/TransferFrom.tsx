...
const TransferFrom: React.FC<TransferFromProps> = ({
  tokenAddress,
  fromAddress,
  toAddress,
  amount,
  ...
  }, [chainId, tokenAddress, fromAddress, toAddress, amount, tokenDecimals]);
  ...
  return (
    <>
      <Button
        ...
        className="w-full"
      >
        {isPending || isConfirming ? 'Transferring...' : 'Transfer From'}
      </Button>
      ...
      <TransactionModal
        ...
        title="Transfer From"
        description={`Transferring ${amount} tokens from ${fromAddress} to ${toAddress}`}
