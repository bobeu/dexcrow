...
const WithdrawFees: React.FC<WithdrawFeesProps> = ({
  onSuccess,
  onError,
}) => {
  ...
  return (
    <>
      <Button
        ...
        className="w-full"
      >
        {isPending || isConfirming ? 'Withdrawing...' : 'Withdraw Fees'}
      </Button>
      ...
      <TransactionModal
        ...
        title="Withdraw Fees"
        description="Withdrawing accumulated platform fees"
