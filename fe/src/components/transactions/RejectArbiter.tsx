...
interface RejectArbiterProps {
  arbiterAddress: string;
  onSuccess?: () => void;
  onError?: (error: string) => void;
}

const RejectArbiter: React.FC<RejectArbiterProps> = ({
  arbiterAddress,
  onSuccess,
  onError,
}) => {
  ...
  const handleRejectArbiter = async () => {
  ...
  return (
    <>
      ...
      <TransactionModal
        ...
        title="Reject Arbiter"
        description={`Rejecting arbiter: ${arbiterAddress}`}
