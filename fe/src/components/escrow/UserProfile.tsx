...
const UserProfile: React.FC = () => {
  ...
  const { userEscrows } = useDataContext();
  ...
  const canTakeAction = (escrow: any, action: string) => {
      ...
      <Card className="p-6">
        <div className="text-center">
          ...
          <p className="text-[#ffff00] font-mono text-sm">
            Please connect your wallet to view your escrow profile.
          </p>
        </div>
      </Card>
    );
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="text-right">
            <p className="text-white font-mono text-sm">
              <strong>Total Escrows:</strong> {userEscrows.length}
            </p>
            <p className="text-white font-mono text-sm">
              <strong>Active:</strong> {userEscrows.filter(e => e.escrowDetails.state < EscrowState.COMPLETED).length}
            </p>
          </div>
        </div>
      </Card>
      ...
      {userEscrows.length === 0 && (
        <Card className="p-6">
          <div className="text-center">
            ...
            <p className="text-[#ffff00] font-mono text-sm">
              You don&apos;t have any escrows as a buyer, seller, or arbiter.
            </p>
          </div>
        </Card>
      )}
