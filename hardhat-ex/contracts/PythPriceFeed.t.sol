...
contract PythPriceFeedTest is Test {
    ...
    function test_AddPriceFeed_Success() public {
        ...
        assertTrue(pythPriceFeed.priceFeedValid(PRICE_FEED_ID));
    }
    ...
    function test_RemovePriceFeed_Success() public {
        ...
        assertFalse(pythPriceFeed.priceFeedValid(PRICE_FEED_ID));
    }
    ...
    function test_GetMaxPriceAge() public {
        assertEq(pythPriceFeed.maxPriceAge(), 3600); // Default 1 hour
    }
